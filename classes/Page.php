  ...
  private $falseCars = ['.php'];
	...
	*/
	...
	private function setViewPath($viewPath =  "view/vue-par-defaut.php"){
		...
		/** TO DO ************************************************************************************************************
		*  This code below must be upgraded : get the plugins registered in config.php and get them here bellow.
		*  Bad practice : write here a fixed value "client" in a class !
		*/
