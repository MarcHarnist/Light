...
-->
	<?php
	   //VARIABLES
		...
		$model = $pluginPath . "/config-localhost-file-reading-model.php";//Required model
		$configFile = "config/config-localhost.php";//Data files to read and  edit
		...
		$messages["adminOnly"] = "Il faut être connecté en tant qu'administrateur du site web";
