...
-->
    ...
    <p><i>Modèle importé : root/modèle/config-file-reading.php</i></p>
    ...
    <p>
    <?php
    // Essaie d'afficher les variables de config
    
        //Data files
    $configFile = "config/config.php"; // Fichier source à lire

    //Other variables
    $rightLevelThisPage = 1;// 1 = superAdmin
	...
	// Redirect user to homepage if not enought rights
    $website->membersPermissions($rightLevelThisPage, $member); 
