...
## A new rooter in class Page for the backoffice "admin"
"__admin-index.php" is renamed "admin.php" and moved into public/admin/.
The controller is renamed "admin-controller.php"
...
## The repertory named "public"

### A lot of repertories and files moved into the repertory "public"
Repertory config, css, img, were moved into root/public !

### The repertory "view" is moved into the repertory "public" !

It was obvious : the view is public !

### First controller in the repertory "public"

The homepage controller in the public repertory (fr: accueil.php)
...
```php
$currentPage = $read->getOneEntryById(TABLE_PAGES, 136);
```
### View Php code
