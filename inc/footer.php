		...
		<footer> <!-- Footer (pied de page) -->
			<ul class="nav col-md-12 col-lg-8 h6 justify-content-end"><!-- usefull to W3C-validator -->
				...
				<address>Propulsé par <a target="_blank" href="http://marcharnist.fr/light" title="CMS Light">"Light"</a>, CMS exigeant peu de ressources créé par <a target="_blank" href="http://marcharnist.fr" title="L'auteur"><?=$website::WEBMASTER;?></a>.</address>
