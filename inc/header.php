<!doctype html>      <!-- www/inc/header  1.0 Hi!  --><html lang="fr">
	<head>
		...
		<meta http-equiv="Content-Type" Content="text/html; charset=UTF-8">
					...
					<!-- Title of the page -->
		<title><?=$website::NAME . ' ' . $page->getTitle();?></title>
	...
	<body>
		<header class="row m-0 p-0 w-100">
			<figure class="col-2 col-lg-1"><!-- col-2 smart phone  -->
				<a href="<?=$website->website_url;?>">
					<img
						class="rounded" 
						src="img/logo.png" 
						alt="Logo: OpenDC, service de Green IT, img/logo.png"
						height="60">
				</a>
			</figure>
			<aside class="col-8 col-xm-8 col-lg-3">
				<h1><a href="<?=$website->website_url;?>"><?=$website::NAME;?></a></h1>
			</aside>
